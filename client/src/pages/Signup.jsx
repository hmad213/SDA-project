...
export default function Signup() {
  ...
  const handleSubmit = (e) =>{
    ...
    if(!formData.address.trim()) newErrors.address = "Please provide an address";
    if(!formData.phone){
    ...
    if(!formData.username.trim()) newErrors.username = "Please provide a username";
    ...
    console.log("Signup successful (more after backend connection)", formData);
    alert("Signup successful (more after backend connection)");
  };
